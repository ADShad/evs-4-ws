    ...
    $(".iframe-fancybox").fancybox({
      ...
      afterLoad: function (instance, slide) {
        ...
        if (
          ...
          const originalAspectRatio = parseInt(iSize[0]) / parseInt(iSize[1]);
          const currentAspectRatio = responsiveWidth / responsiveHeight;

          if (currentAspectRatio > originalAspectRatio) {
            responsiveWidth = responsiveHeight * originalAspectRatio;
          } else {
            responsiveHeight = responsiveWidth / originalAspectRatio;
          }
          ...
          // Set iframe dimensions to match container
          $(".fancybox-content iframe").css({
            width: "100%",
            // height: "inherit",
          });
          ...
          // For content without explicit size, use responsive sizing
      ...
      if (key != "zother") {
        ...
        for (var i = 0; i < mItem.data.length; i++) {
          ...
          if (mItem["link"] == "iframe") {
            ...
            var chapter_menu = `<li class="hide"><a href="#"><i class="fa fa-video-camera"></i> <span class="nav-label">${currChapter}</span> <span class="fa arrow"></span></a><ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">`;
